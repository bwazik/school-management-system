            ...
            <div class="swiper-container swiper-container-horizontal swiper swiper-card-advance-bg"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="row">
                            <div class="col-12">
                                <h5 class="text-white mb-0 mt-2">Website
                                    Analytics</h5>
                    ...
                    <div class="swiper-slide">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-9 col-12 order-2 order-md-1">
                                <h6 class="text-white mt-0 mt-md-3 mb-3">Revenue
                                    Sources</h6>
                                <div class="row">
                                    <div class="col-6">
                                        <ul class="list-unstyled mb-0">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <small class="d-block mb-1 text-muted">Sales
                            Overview</small>
            ...
            <div class="card h-100">
                <div class="card-header pb-0 d-flex justify-content-between mb-lg-n4">
                    <div class="card-title mb-0">
                        ...
                        <small class="text-muted">Weekly Earnings
                            Overview</small>
                    </div>
                    <div class="dropdown">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-4 d-flex flex-column align-self-end">
                            ...
                            <small class="text-muted">You informed of this week
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                    <div class="me-2">
                                        ...
                                        <small class="text-muted">Direct link
                                            click</small>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <p class="mb-0">1.2k</p>
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                    <div class="me-2">
                                        ...
                                        <small class="text-muted">Impact Radius
                                            Visits</small>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <p class="mb-0">342</p>
