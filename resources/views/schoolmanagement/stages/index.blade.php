...
@section('pageTitle')
    {{ trans('layouts/sidebar.stages') }} - {{ trans('layouts/sidebar.program') }}
@endsection
...
@section('breadcrumb2')
    {{ trans('layouts/sidebar.stages') }}
@endsection

@section('content')
    @include('schoolmanagement.stages.modals')
@endsection
...
@section('js')
    ...
    <script>
        $('#add-form').on('submit', function(e) {
            ...
            var myOffcanvas = bootstrap.Offcanvas.getInstance(document.querySelector("#add-stage-modal"));
    ...
    {{-- Edit Stage --}}
    <script>
        $('body').on('click', '#edit-stage-button', function(e) {
            e.preventDefault();
            ...
            $('#edit-stage-modal #id').val(id);
            $('#edit-stage-modal #name_ar').val(name_ar);
            $('#edit-stage-modal #name_en').val(name_en);
        });
        ...
        $('#edit-form').on('submit', function(e) {
            ...
            var myOffcanvas = bootstrap.Offcanvas.getInstance(document.querySelector("#edit-stage-modal"));
    ...
    {{-- Delete Stage --}}
    <script>
        $('body').on('click', '#delete-stage-button', function(e) {
            e.preventDefault();
            ...
            $('#delete-stage-modal #id').val(id);
            $('#delete-stage-modal #name').val(name_ar + '  -  ' + name_en);
        });
